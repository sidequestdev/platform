...
![Scrolling the ground diagram](./img/scrolling-ground-dark.png)
...
Try to map the arguments for both draw calls to the diagram above, it will help to make the concept stick. They are color coded to help tell the draw and sampling apart.
