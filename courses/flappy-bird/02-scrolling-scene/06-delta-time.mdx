...
<AlertInfo title="Accounting For Inactive Tabs">
...
```typescript title="src/main.ts" +{5}
...
```typescript title="src/entities/ground.ts" +{4-5}
export class Ground {
  // ...
...
```typescript title="src/main.ts" +{1,3-4,8,25}
