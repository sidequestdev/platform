...
:::alert{title="Error Handling" type="info"}
You'll notice the use of `if (context == null)` checks in our code. We're intentionally avoiding the null-assertion opterator (`!`) in favour of clearer assertions to get type safey.
:::
