...
export default function Index() {
  return (
    <>
      <div
        className="navbar sticky top-0 bg-base-100 shadow-md"
        style={{
          zIndex: 100,
        }}
      >
        <div className="drawer-button flex-none lg:hidden">
      ...
      <div className="drawer-mobile drawer">
        ...
        <div className="drawer-content flex flex-col px-4">
          ...
          <h1 className="pb-4 text-4xl font-semibold">Welcome</h1>
          ...
          <ul className="menu menu-compact w-80 overflow-y-auto pl-2 text-base-content">
            ...
            <ul className="menu menu-compact ml-3 overflow-y-auto text-base-content">
              <li className="bordered">
                <a>Drawing the Bird</a>
              </li>
              <li>
                <a>Collision Detection</a>
              </li>
            </ul>
            <li>
              <a>Sidebar Item 2</a>
